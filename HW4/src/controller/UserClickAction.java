 ...
 * his photos.
 */
public class UserClickAction extends Action {  
    private FormBeanFactory<IdForm> idFormFactory = FormBeanFactory.getInstance(IdForm.class);
    private UserDAO userDAO;
    private FavoriteDAO favoriteDAO;

    public UserClickAction(Model model) {
        userDAO = model.getUserDAO();
        favoriteDAO = model.getFavoriteDAO();
    }

    public String getName() { return "userclick.do"; }
    ...
    public String perform(HttpServletRequest request) {
        ...
        try {          
            ...
            if (favorite == null) {
                ...
                return "manegelist.jsp";
            }
            
            //update click count
            favoriteDAO.update(favorite_idInt);
